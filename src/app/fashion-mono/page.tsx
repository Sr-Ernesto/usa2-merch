...
export default function FashionMono() {
  useEffect(() => {
    ...
    document.documentElement.style.setProperty("--accent", "0 0% 70%");
    document.documentElement.style.setProperty("--muted", "0 0% 10%");
    document.documentElement.style.setProperty("--muted-foreground", "0 0% 50%");
    document.documentElement.style.setProperty("--border", "0 0% 15%");
    document.documentElement.style.setProperty("--ring", "0 0% 100%");
  }, []);
