...
export default function FashionTeal() {
  useEffect(() => {
    document.documentElement.style.setProperty("--background", "180 20% 5%");
    document.documentElement.style.setProperty("--foreground", "170 15% 95%");
    document.documentElement.style.setProperty("--primary", "170 70% 48%");
    document.documentElement.style.setProperty("--primary-foreground", "0 0% 100%");
    document.documentElement.style.setProperty("--accent", "340 80% 65%");
    document.documentElement.style.setProperty("--muted", "180 12% 11%");
    document.documentElement.style.setProperty("--muted-foreground", "180 8% 55%");
    document.documentElement.style.setProperty("--border", "180 12% 15%");
    document.documentElement.style.setProperty("--ring", "170 70% 48%");
  }, []);
