...
export default function FashionSage() {
  useEffect(() => {
    document.documentElement.style.setProperty("--background", "140 15% 6%");
    document.documentElement.style.setProperty("--foreground", "40 20% 95%");
    document.documentElement.style.setProperty("--primary", "120 35% 55%");
    document.documentElement.style.setProperty("--primary-foreground", "0 0% 100%");
    document.documentElement.style.setProperty("--accent", "90 50% 60%");
    document.documentElement.style.setProperty("--muted", "140 10% 12%");
    document.documentElement.style.setProperty("--muted-foreground", "140 8% 55%");
    document.documentElement.style.setProperty("--border", "140 10% 16%");
    document.documentElement.style.setProperty("--ring", "120 35% 55%");
  }, []);
